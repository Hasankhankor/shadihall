				...
				<Box bg="#f9f9fa" pb="6rem">
					<Box>
						...
						>
							...
							<Flex w="20%" justifyContent="space-evenly" color="white">
								<Image
									borderRadius="50%"
									background="none"
									width={25}
						...
						<Box w="80%" m="auto">
							<Text fontSize="2xl" mb="1.5rem">
								List your property on Booking.com and start welcoming guests in
								no time!
							</Text>
							...
							>
								...
								<Image
									...
									m="auto"
									mb="10px"
									src="https://q.bstatic.com/static/img/join/segmentation/accomm_one_apt_main@2x.png"
								/>
								<Text
									textAlign="center"
									fontSize="md"
								...
								<Box w="75%" m="auto" mb="1rem">
									<Text textAlign="center" fontSize="xs">
										Furnished and self-catering accommodation, where guests rent
										the entire place.
									</Text>
								</Box>
