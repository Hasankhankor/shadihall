          ...
          <Box p="1rem 3rem 1rem 2rem" display="flex" bg="#003580" mb="1rem" justifyContent="space-between">
            ...
            <Flex w="20%" justifyContent="space-evenly" color="white">
              <Image
                ...
                alt="IND"
                src="ind.jpeg"
              />Help <BsQuestionCircle fontSize="1.5rem" cursor="pointer" /> <CgProfile cursor="pointer" fontSize="1.5rem" />
            </Flex>
          </Box>
            ...
            <Flex p={8} flex={1} align={'center'} justify={'center'}>
              <Stack spacing={4} w={'full'} maxW={'md'}>
                ...
                <Stack spacing={6}>
                  ...
                  <Link href="/">
                    <Button w="100%" border="1px solid #0071c2" textDecoration="none" _hover={{ bg: "#b7cedf" }} color="#014778">
                      Back to home
                    </Button>
                  </Link>
                </Stack>
